            ...
            for($no=0;$no<count($this->elementArray[$parentID]);$no++)
            {
                ...
                if($this->elementArray[$parentID][$no]['category'] == 'file')                  
                {
                    ...
                    echo "<img class=\"tree_plusminus\" id=\"plusMinus"
                                        ...
                                        . "\" src=\"http://localhost/senior-projects//img/plus_folder.png\">"
                                        . "<img src=\"".$this->elementArray[$parentID][$no]['icon']."\">";
                    echo "<a class=\"tree_link\"$urlAdd$onclick>" 
                    ...
                    if($this->elementArray[$parentID][$no]['date'] > $this->due_date)
                    {
                        $attributes1 = array(
                            'class' => '',
                            'style' => 'float:right;'
                    ...
                    echo form_label($this->elementArray[$parentID][$no]['date'], 'due_date', $attributes1);
                ...
                elseif($this->elementArray[$parentID][$no]['category'] == 'milestone')
                {
                    ...
                    echo "<img class=\"tree_plusminus\" id=\"plusMinus"
                                     ...
                                     . "\" src=\"http://localhost/senior-projects//img/plus_folder.png\">"
                                     . "<img src=\"".$this->elementArray[$parentID][$no]['icon']."\">";
                    echo "<b><a class=\"tree_link\"$urlAdd$onclick>"
                    ...
                    if(!$this->elementArray[$parentID][$no]['date'] == "")
                    {
                        ...
                        echo form_label('[ Due Date:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp'
