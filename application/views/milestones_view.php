...
<?php 
    ...
    $show_hide = isset($_POST['show_hide']);
?>
        <div>
        ...
        <div class ="well">       
            ...
            <form name="checkbox" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                <input type="checkbox" name="show_hide" value="<?php echo $show_hide; ?>" 
                       onClick="submit();" style="margin-bottom:5px;margin-left:15px " <?php echo $checked;?> > Show Deleted
            </form>
            <?php
            ...
            if(mysql_num_rows(mysql_query("SHOW TABLES LIKE 'spw_milestones'")) == 1) 
            {
                ...
                if ($num_rows > 0)
                {
                    ...
                    {                                                                                            
                        ...
                        if($row['deleted'] == 'true')
                        {
                            echo "<td><input type=\"text\" name=\"milestone[".$count."][name]\" value=\""
                                    . $row['milestone_name']."\" style=\"color:red;\">&nbsp&nbsp"
                                    . "<input type=\"checkbox\" name=\"milestone[".$count."][restore]\" value=\"" 
                                    . $row['milestone_id']."\" style=\"margin-bottom:25px\">&nbsp&nbspRestore"
                                    . "</td>";
                        } else {
                            echo "<td><input type=\"text\" name=\"milestone[".$count."][name]\" value=\""
                                    . $row['milestone_name']."\">"
           ...
           <?php 
                echo anchor('http://localhost/senior-projects/files/project_files', 'Back', array(
